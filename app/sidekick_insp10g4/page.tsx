...
const PROMPT_TEXT = "My brother is three eggnogs deep at dinner and just started a sentence with 'You know what the real problem is?' Give me an emergency topic change he won't notice."
const PAGE_SOURCE = 'sidekick_insp10g4'

function Insp10g4Content() {
                            ...
                            {isRevealed ? (
                                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-4">
                                    <div className="relative font-mono text-base md:text-lg text-teal p-6 bg-navy rounded-xl border-2 border-teal shadow-2xl whitespace-pre-wrap leading-relaxed">
                                        ...
                                        My brother is three eggnogs deep at dinner and just started a sentence with &quot;You know what the real problem is?&quot; Give me an emergency topic change he won&apos;t notice.
                                    </div>
                                </motion.div>
                            ) : (
                            ...
                            <Card className="p-6 shadow-lg border-2 border-navy bg-white w-full rounded-xl">
                                ...
                                <div className="space-y-3">
                                    <div className="bg-teal/10 rounded-xl p-4 border border-teal/20">
                                        ...
                                        <p className="text-gray-800 text-base leading-relaxed">
                                            My teen hasn&apos;t said more than one syllable since September. I think I&apos;ve been replaced by a hoodie and a grunt. You are an FBI Interrogator and a Teen Anthropologist. What psychological trick unlocks teen speech?
                                        </p>
                                    </div>
                                    <div className="bg-slate-100 rounded-xl p-4 border-l-4 border-navy">
                            ...
                            <Card className="p-6 shadow-lg border-2 border-navy bg-white w-full rounded-tr-[30px]">
                                ...
                                <div className="space-y-3">
                                    <div className="bg-teal/10 rounded-xl p-4 border border-teal/20">
                                        ...
                                        <p className="text-gray-800 text-base leading-relaxed">
                                            Translate this into Boomer so I understand what my nephew said: &quot;No cap, the fit has drip. Bet.&quot; And tell me how I reply.
                                        </p>
                                    </div>
                                    <div className="bg-slate-100 rounded-xl p-4 border-l-4 border-navy">
                                        <p className="text-sm font-bold text-navy mb-2 uppercase tracking-wider">AI, fluent in Gen Z:</p>
                                        <p className="text-gray-800 text-base leading-relaxed">
                                            No cap = I&apos;m not lying. The fit has drip = Your outfit looks really good. Bet = For sure / absolutely. Full sentence in Boomer: &quot;I&apos;m being serious — your outfit looks really cool. Absolutely.&quot;
                                        </p>
                                    </div>
                                </div>
                            </Card>
...
export default function SidekickInsp10g4Page() {
    return (
