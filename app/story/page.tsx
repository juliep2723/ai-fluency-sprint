    ...
    <main className="min-h-screen">
      ...
      <section className="py-24 px-6 bg-light-gray">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-navy text-center mb-20">Meet Your Guides</h2>
          
          <div className="grid md:grid-cols-2 gap-12">
            {/* Michele */}
            <Card className="p-12 shadow-lg hover:shadow-xl transition-shadow duration-300 border-0 bg-white">
              <div className="mb-8">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-navy text-center mb-20">The Executive AI Fluency Sprint</h2>
      ...
      <section className="py-24 px-6 bg-light-gray">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-navy text-center mb-20">Frequently Asked Questions</h2>
