...
const PAGE_SOURCE = 'sidekick_insp11test'

function Insp11testContent() {
                                ...
                                <div className="space-y-3">
                                    <div className="bg-teal/10 rounded-xl p-4 border border-teal/20">
                                        ...
                                        <p className="text-gray-800 text-lg leading-normal">
                                            My brother is three cocktails deep and just said &quot;You know what the real problem is?&quot; <strong>I need a topic change he won&apos;t notice.</strong>
                                        </p>
                                    </div>
                            ...
                            <Card className="p-6 shadow-lg border-2 border-navy bg-white w-full rounded-tl-[30px] rounded-br-[30px]">
                                ...
                                <div className="space-y-3">
                                    <div className="bg-teal/10 rounded-xl p-4 border border-teal/20">
                                        ...
                                        <p className="text-gray-800 text-lg leading-normal">
                                            My ex just texted &quot;hey&quot; at midnight. You are a Dating Coach and a Statistician. <strong>What are the odds this is destiny vs. Wi-Fi and whiskey?</strong>
                                        </p>
                                    </div>
                                    <div className="bg-slate-100 rounded-xl p-4 border-l-4 border-navy">
...
export default function SidekickInsp11testPage() {
    return (
